...
const RegistrationStatus = () => {
  ...
  return (
    ...
    >
      <Steps>
        <Step title="Pendaftaran" description="Pendaftaran anak" status='finish' />
        <Step title="Verifikasi" description="Pemeriksaan Data Pendaftar" status='process' />
        <Step title="Pembayaran" description="Pembayaran masuk sekolah" />
      </Steps>
